...

{
  ...
  flake.nixosConfigurations.qmoran-desktop = inputs.nixpkgs.lib.nixosSystem {
    modules = [
      self.nixosModules.qmoran-desktop
  ...
  flake.nixosModules.qmoran-desktop = { config, lib, pkgs, modulesPath, ... } :{
    imports =[ 
