...

{
  ...
  flake.nixosConfigurations.pt1 = inputs.nixos-raspberrypi.lib.nixosSystem {
    modules = [
  ...
  flake.nixosModules.pt1 = { config, lib, pkgs, modulesPath, ... } :{
    ...
    fileSystems."/boot" =
      { device = "/dev/disk/by-uuid/E22C-AF9C";
        fsType = "vfat";
